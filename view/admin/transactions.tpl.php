<?php
    ...
    if (!Auth::checkAcl("owner")): print Message::msgError(Lang::$word->NOACCESS);
        return; endif;
?>
<h2><?php echo Lang::$word->TRX_TITLE; ?></h2>
<p class="wojo small text"><?php echo Lang::$word->TRX_INFO; ?></p>
<div class="wojo card" id="pData">
  <div class="header">
    <div class="row horizontal gutters align middle">
      <div class="columns">
        <a data-wdropdown="#dropdown-transMenu" class="wojo dark inverted icon button">
...
<div class="wojo form segment">
  <form method="post" id="wojo_form" action="<?php echo Url::url(Router::$path); ?>" name="wojo_form">
    <div class="row align center middle gutters">
      ...
      <div class="columns auto phone-hide">
        <a href="<?php echo ADMINVIEW; ?>/helper.php?action=exportAllTransactions" class="wojo primary icon button"><i
            class="icon wysiwyg table"></i></a>
      </div>
    </div>
  </form>
    <?php if ($this->data): ?>
      <table class="wojo responsive basic table">
        ...
        <tr>
          ...
          <th><?php echo Lang::$word->TRX_MEMNAME; ?></th>
          <th><?php echo Lang::$word->NAME; ?></th>
          <th><?php echo Lang::$word->TRX_PROCESSOR; ?></th>
          ...
          <?php foreach ($this->data as $row): ?>
            ...
            <tr id="item_<?php echo $row->id; ?>">
              ...
              <td class="auto"><?php echo Date::doDate("short_date", $row->created); ?></td>
            </tr>
          <?php endforeach; ?>
      </table>
...
<?php if ($this->data): ?>
  <div class="row gutters align middle">
    <div class="columns auto mobile-100 phone-100">
      <div
        class="wojo small semi text"><?php echo Lang::$word->TOTAL . ': ' . $this->pager->items_total; ?> / <?php echo Lang::$word->CURPAGE . ': ' . $this->pager->current_page . ' ' . Lang::$word->OF . ' ' . $this->pager->num_pages; ?></div>
    </div>
    <div class="columns right aligned mobile-100 phone-100"><?php echo $this->pager->display_pages('small'); ?></div>
  </div>
<?php endif; ?>
